...
> **⚠️ CRITICAL:** Before implementing pages, read [Page Widget Best Practices](29_PAGE_WIDGET_BEST_PRACTICES.md) to avoid common anti-patterns. Page widgets MUST be < 300 lines and delegate business logic to services/notifiers.
...
- **Page Widget Standards:** Best practices in [29_PAGE_WIDGET_BEST_PRACTICES.md](29_PAGE_WIDGET_BEST_PRACTICES.md)
- **Refactoring Guide:** How to refactor existing code in [30_REFACTORING_GUIDE.md](30_REFACTORING_GUIDE.md)
