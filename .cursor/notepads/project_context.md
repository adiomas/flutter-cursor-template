# Project Context - Omiline Boat Management

> **Use @project_context.md when starting new feature or need project overview**

## Project Overview

**Type**: Charter boat fleet management application  
...
1. **Yacht Analysis** (Python scripts)
   - Price analysis
   - Discount calculations
   - Google Sheets integration

2. **Boat Management** (Flutter - in development)
   - Fleet overview
   - Booking system
   - Analytics dashboard
...
All user-facing text must be in Croatian:
- Error messages
- Button labels
- Placeholders
- Validation messages
